...
},{}],"../node_modules/date-fns/esm/getMonth/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/date-fns/esm/getDaysInMonth/index.js":[function(require,module,exports) {
"use strict";
...
},{"../_lib/toInteger/index.js":"../node_modules/date-fns/esm/_lib/toInteger/index.js","../toDate/index.js":"../node_modules/date-fns/esm/toDate/index.js","../getDaysInMonth/index.js":"../node_modules/date-fns/esm/getDaysInMonth/index.js"}],"../node_modules/date-fns/esm/subMonths/index.js":[function(require,module,exports) {
"use strict";
...
},{"../_lib/toInteger/index.js":"../node_modules/date-fns/esm/_lib/toInteger/index.js","../addMonths/index.js":"../node_modules/date-fns/esm/addMonths/index.js"}],"../node_modules/date-fns/esm/getYear/index.js":[function(require,module,exports) {
"use strict";
...
},{"../toDate/index.js":"../node_modules/date-fns/esm/toDate/index.js"}],"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"components/Episode.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    ...
    pageValues: function pageValues() {
  ...
  methods: {
    getStats: function getStats() {
      ...
      fetch('/api/podcaster/stats/' + this.podcasterSlug + '/year/' + this.currentYear + '/month/' + (this.currentMonth + 1), {
        ...
        _this.episodes = _this.computeStats(response.stats);
      }).catch(function (error) {
        _this.error = error;
        console.log(_this.error);
      });
    },
    computeStats: function computeStats(stats) {
      var episodeStats = stats.episodes.map(function (episode) {
        return {
          title: episode.episode.replace(/-/g, ' '),
    ...
    prevMonth: function prevMonth() {
      var newDate = (0, _subMonths.default)(this.currentDate, 1);
      this.currentDate = newDate;
      this.setNewDateVars();
    },
    nextMonth: function nextMonth() {
      var newDate = (0, _addMonths.default)(this.currentDate, 1);
      this.currentDate = newDate;
      this.setNewDateVars();
    },
    setNewDateVars: function setNewDateVars() {
      this.currentMonth = (0, _getMonth.default)(this.currentDate);
      this.currentYear = (0, _getYear.default)(this.currentDate);
      this.currentMonthName = this.currentDate.toLocaleString('en', {
        month: 'long'
      });
...
exports.default = _default;
        var $be7241 = exports.default || module.exports;
      
      if (typeof $be7241 === 'function') {
        $be7241 = $be7241.options;
      }
    
        /* template */
        Object.assign($be7241, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "section",
    { staticClass: "k-modified-section" },
    [
      _c("div", { staticClass: "podcaster-prev-next" }, [
        _c(
          "button",
          { staticClass: "k-link k-button", on: { click: _vm.prevMonth } },
          [_c("k-icon", { attrs: { type: "angle-left" } })],
          1
        ),
        _vm._v(" "),
        _c(
          "button",
          { staticClass: "k-link k-button", on: { click: _vm.nextMonth } },
          [_c("k-icon", { attrs: { type: "angle-right" } })],
          1
        )
      ]),
      _vm._v(" "),
      _c("k-text", [_vm._v(_vm._s(_vm.error))]),
      _vm._v(" "),
      _c("k-headline", [_vm._v(_vm._s(_vm.headline))]),
      _vm._v(" "),
      _c(
        "table",
        { attrs: { id: "episodeStats" } },
        _vm._l(_vm.episodes, function(episode) {
          return _c("tr", [
            _c("td", [_vm._v(_vm._s(episode.downloads))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(episode.title))])
          ])
        }),
        0
      )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$be7241', $be7241);
          } else {
            api.reload('$be7241', $be7241);
          }
        }
...
},{"date-fns/getMonth":"../node_modules/date-fns/esm/getMonth/index.js","date-fns/addMonths":"../node_modules/date-fns/esm/addMonths/index.js","date-fns/subMonths":"../node_modules/date-fns/esm/subMonths/index.js","date-fns/getYear":"../node_modules/date-fns/esm/getYear/index.js","_css_loader":"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/frappe-charts/dist/frappe-charts.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.AxisChart = exports.Heatmap = exports.PieChart = exports.PercentageChart = exports.Chart = void 0;
...
exports.Chart = Chart;
},{}],"../node_modules/frappe-charts/dist/frappe-charts.min.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/YearGraph.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    var year = (0, _getYear.default)(this.currentDate);
    this.podcasterSlug = this.sanitizeTitle(this.pageValues.podcastertitle);
    this.getStats(year);
  },
  methods: {
    getStats: function getStats(year) {
      var _this = this;
      ...
      fetch('/api/podcaster/stats/' + this.podcasterSlug + '/episodes/yearly-downloads/' + year + '+' + (year - 1), {
        ...
        _this.addChartData(response.stats, year);
      }).catch(function (error) {
        _this.error = error;
      });
    },
    addChartData: function addChartData(stats, year) {
      var chartData = {
        current: {
          name: year,
    ...
    drawChart: function drawChart() {
      var chart = new _frappeChartsEsm.Chart('#chart', {
...
exports.default = _default;
        var $b6ad78 = exports.default || module.exports;
      
      if (typeof $b6ad78 === 'function') {
        $b6ad78 = $b6ad78.options;
      }
    
        /* template */
        Object.assign($b6ad78, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b6ad78', $b6ad78);
          } else {
            api.reload('$b6ad78', $b6ad78);
          }
        }
...
},{"date-fns/getYear":"../node_modules/date-fns/esm/getYear/index.js","frappe-charts/dist/frappe-charts.esm.js":"../node_modules/frappe-charts/dist/frappe-charts.esm.js","frappe-charts/dist/frappe-charts.min.css":"../node_modules/frappe-charts/dist/frappe-charts.min.css","_css_loader":"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"utils.js":[function(require,module,exports) {
"use strict";
...
var _default = sanitizeTitle;
exports.default = _default;
},{}],"components/TopTen.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    this.podcasterSlug = (0, _utils.default)(this.pageValues.podcastertitle);
    this.getStats();
  },
  created: function created() {
    var _this = this;
  ...
  methods: {
    getStats: function getStats() {
      ...
      fetch('/api/podcaster/stats/' + this.podcasterSlug + '/top/' + this.limit, {
        ...
        _this2.topEpisodes = _this2.computeStats(response.stats);
      }).catch(function (error) {
        _this2.error = error;
      });
    },
    computeStats: function computeStats(stats) {
      var episodeStats = stats.map(function (episode) {
        return {
          title: episode.episode.replace(/-/g, ' '),
          downloads: episode.downloaded
        };
...
exports.default = _default;
        var $9fd220 = exports.default || module.exports;
      
      if (typeof $9fd220 === 'function') {
        $9fd220 = $9fd220.options;
      }
    
        /* template */
        Object.assign($9fd220, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      ...
      _c(
        "table",
        { attrs: { id: "topTen" } },
        _vm._l(_vm.topEpisodes, function(episode) {
          return _c("tr", [
            _c("td", [_vm._v(_vm._s(episode.downloads))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(episode.title))])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$9fd220', $9fd220);
          } else {
            api.reload('$9fd220', $9fd220);
          }
        }
...
},{"../utils":"utils.js","_css_loader":"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/FeedStats.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    drawChart: function drawChart() {
      var chart = new _frappeChartsEsm.Chart('#feedChart', {
...
exports.default = _default;
        var $1a9680 = exports.default || module.exports;
      
      if (typeof $1a9680 === 'function') {
        $1a9680 = $1a9680.options;
      }
    
        /* template */
        Object.assign($1a9680, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1a9680', $1a9680);
          } else {
            api.reload('$1a9680', $1a9680);
          }
        }
...
},{"date-fns/getYear":"../node_modules/date-fns/esm/getYear/index.js","frappe-charts/dist/frappe-charts.esm.js":"../node_modules/frappe-charts/dist/frappe-charts.esm.js","frappe-charts/dist/frappe-charts.min.css":"../node_modules/frappe-charts/dist/frappe-charts.min.css","../utils":"utils.js","_css_loader":"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/Wizard.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $2868a6 = exports.default || module.exports;
      
      if (typeof $2868a6 === 'function') {
        $2868a6 = $2868a6.options;
      }
    
        /* template */
        Object.assign($2868a6, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "section",
    { staticClass: "k-modified-section podcaster-import-wizard" },
    [
      _c("k-headline", [_vm._v(_vm._s(_vm.headline))]),
      _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2868a6', $2868a6);
          } else {
            api.reload('$2868a6', $2868a6);
          }
        }
...
var _Episode = _interopRequireDefault(require("./components/Episode.vue"));

var _YearGraph = _interopRequireDefault(require("./components/YearGraph.vue"));

var _TopTen = _interopRequireDefault(require("./components/TopTen.vue"));

var _FeedStats = _interopRequireDefault(require("./components/FeedStats.vue"));

var _Wizard = _interopRequireDefault(require("./components/Wizard.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

panel.plugin('mauricerenck/podcaster', {
  sections: {
    'podcasterEpisodeStats': _Episode.default,
    'podcasterYearlyGraph': _YearGraph.default,
    'podcasterTopTen': _TopTen.default,
    'podcasterFeedStats': _FeedStats.default,
    'podcasterWizard': _Wizard.default
  }
});
},{"./components/Episode.vue":"components/Episode.vue","./components/YearGraph.vue":"components/YearGraph.vue","./components/TopTen.vue":"components/TopTen.vue","./components/FeedStats.vue":"components/FeedStats.vue","./components/Wizard.vue":"components/Wizard.vue"}],"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
