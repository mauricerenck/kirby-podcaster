(function() {
  ...
  var _sfc_render$c = function render() {
    ...
    return _c("k-panel-inside", [_c("k-view", { staticClass: "k-podcaster-view" }, [_c("k-header", [_vm._v("Podcaster Analytics")]), _c("k-grid", { attrs: { "gutter": "small" } }, [_c("k-column", { attrs: { "width": "1/4" } }, [_c("k-select-field", { attrs: { "options": _vm.podcastOptions, "label": "Podcast", "name": "select" }, on: { "input": _vm.setPodcast }, model: { value: _vm.selectedPodcast, callback: function($$v) {
      _vm.selectedPodcast = $$v;
    }, expression: "selectedPodcast" } })], 1), _c("k-column", { attrs: { "width": "4/4" } }, [_c("k-line-field"), _c("PodStatWidget", { attrs: { "selectedPodcast": this.selectedPodcast } }), _c("k-line-field")], 1), _c("k-column", { attrs: { "width": "4/6" } }, [_c("k-headline", { attrs: { "size": "huge" } }, [_vm._v("Monthly stats")])], 1), _c("k-column", { attrs: { "width": "1/6" } }, [_c("k-number-field", { attrs: { "step": 1, "label": "Year" }, on: { "input": _vm.setYear }, model: { value: _vm.selectedYear, callback: function($$v) {
      _vm.selectedYear = $$v;
      ...
      !function(t, e) {
        ...
        var C = { name: "en", options: { months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], shortDays: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], toolbar: { exportToSVG: "Download SVG", exportToPNG: "Download PNG", exportToCSV: "Download CSV", menu: "Menu", selection: "Selection", selectionZoom: "Selection Zoom", zoomIn: "Zoom In", zoomOut: "Zoom Out", pan: "Panning", reset: "Reset Zoom" } } }, L = function() {
          ...
          return r(t2, [{ key: "getElTooltip", value: function(t3) {
            ...
            } else C2.tooltipLabels.drawSeriesTexts(e({ shared: false }, F2)), this.tooltipUtil.hasBars() && C2.tooltipPosition.moveStickyTooltipOverBars(s2), L2 && C2.tooltipPosition.moveMarkers(a2, s2);
          } }]), t2;
        }(), vt = function() {
          function t2(e2) {
        ...
        Xt = "undefined" != typeof window ? window : void 0, Et = function(t2, e2) {
          ...
          return a2;
        }, "object" === i(exports) && true ? module.exports = Xt.document ? Et(Xt, Xt.document) : function(t2) {
        ...
        var Bt = function() {
          ...
          return r(t2, [{ key: "render", value: function() {
            ...
            return new Promise(function(s2, r2) {
              ...
              if (i2.annotations = new P(i2), i2.annotations.drawImageAnnos(), i2.annotations.drawTextAnnos(), "back" === a2.config.grid.position && o2 && (a2.globals.dom.elGraphical.add(o2.el), o2 && o2.elGridBorders && o2.elGridBorders.node && a2.globals.dom.elGraphical.add(o2.elGridBorders)), Array.isArray(e2.elGraph)) for (var n2 = 0; n2 < e2.elGraph.length; n2++) a2.globals.dom.elGraphical.add(e2.elGraph[n2]);
  ...
  var vueApexchartsExports = vueApexcharts.exports;
  const VueApexCharts = /* @__PURE__ */ getDefaultExportFromCjs(vueApexchartsExports);
  const _sfc_main$b = {
    ...
    methods: {
      async getEpisodeGraphData() {
        ...
        this.selectedEpisodes.forEach(async (episode) => {
          ...
          graphData.push({ name: episode, data });
        });
  ...
  const _sfc_main$4 = {
    ...
    methods: {
      getDeviceGraphData() {
        this.$api.get(`podcaster/stats/graph/devices/${this.selectedPodcast}/${this.selectedYear}/${this.selectedMonth}`).then((response) => {
          if (!response) {
            return;
          }
          const devices = [];
  ...
  const _sfc_main$3 = {
    ...
    methods: {
      getUserAgentGraphData() {
        this.$api.get(`podcaster/stats/graph/useragents/${this.selectedPodcast}/${this.selectedYear}/${this.selectedMonth}`).then((response) => {
          if (!response) {
            return;
          }
          const agents = [];
  ...
  const _sfc_main$2 = {
    ...
    methods: {
      getSystemsGraphData() {
        this.$api.get(`podcaster/stats/graph/os/${this.selectedPodcast}/${this.selectedYear}/${this.selectedMonth}`).then((response) => {
          if (!response) {
            return;
          }
          const systems = [];
      ...
      async getEpisodeGraphData() {
        ...
        this.$api.get(`podcaster/stats/graph/episodes/${this.selectedPodcast}`).then((response) => {
          ...
          response.downloads.forEach((entry) => {
            data.push({ x: (/* @__PURE__ */ new Date(`${entry.year}-${entry.month}-02`)).getTime(), y: entry.downloads });
          });
