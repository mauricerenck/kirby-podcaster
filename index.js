(function() {
  ...
  var render$6 = function() {
    ...
    return _c("k-inside", [_c("k-view", { staticClass: "k-podcaster-view" }, [_c("k-header", [_vm._v("Podcaster Analytics")]), _c("k-select-field", { attrs: { "options": _vm.podcastOptions, "label": "Podcast", "name": "select" }, on: { "input": _vm.setPodcast }, model: { value: _vm.selectedPodcast, callback: function($$v) {
      _vm.selectedPodcast = $$v;
    }, expression: "selectedPodcast" } }), _c("k-column", [_c("k-headline", { attrs: { "size": "huge" } }, [_vm._v("Monthly stats " + _vm._s(_vm.selectedMonth) + "/" + _vm._s(_vm.selectedYear))])], 1), _c("k-grid", [_c("k-column", { attrs: { "width": "1/4" } }, [_c("k-number-field", { attrs: { "step": 1, "label": "Year" }, on: { "input": _vm.setYear }, model: { value: _vm.selectedYear, callback: function($$v) {
      _vm.selectedYear = $$v;
    }, expression: "selectedYear" } }), _c("k-number-field", { attrs: { "max": 12, "min": 1, "step": 1, "label": "Month" }, on: { "input": _vm.setMonth }, model: { value: _vm.selectedMonth, callback: function($$v) {
      _vm.selectedMonth = $$v;
    }, expression: "selectedMonth" } })], 1), _c("k-column", { attrs: { "width": "3/4" } }, [_c("PodStatWidget", { attrs: { "selectedPodcast": this.selectedPodcast } })], 1), _c("k-column", [_c("PodGraphEpisodesMonth", { attrs: { "selectedMonth": this.selectedMonth, "selectedYear": this.selectedYear, "selectedPodcast": this.selectedPodcast } })], 1), _c("k-column", [_c("k-headline", { attrs: { "size": "huge" } }, [_vm._v("Overall stats")])], 1), _c("k-column", { attrs: { "width": "2/3" } }, [_c("PodGraphSingleEpisode", { attrs: { "selectedPodcast": this.selectedPodcast, "selectedEpisode": this.selectedEpisode } })], 1), _c("k-column", { attrs: { "width": "1/3" } }, [_c("PodEpisodesAutocomplete", { attrs: { "selectedPodcast": this.selectedPodcast, "selectedEpisode": this.selectedEpisode, "onSelectEpisode": this.setEpisode } }), _c("PodTopEpisodes", { attrs: { "selectedPodcast": this.selectedPodcast, "onSelectEpisode": this.setEpisode } })], 1)], 1), _vm._v(" Overall Downloads Estimated Subscribers UserAents Devices OS Location "), _c("DetailsByMonth", { attrs: { "summary": _vm.summary } }), _c("Targets", { attrs: { "targets": _vm.targets } }), _c("Sources", { attrs: { "sources": _vm.sources } }), _c("Sent", { attrs: { "outbox": _vm.sent } })], 1)], 1);
  };
  var staticRenderFns$6 = [];
  render$6._withStripped = true;
  var Analytics_vue_vue_type_style_index_0_lang = "";
  ...
  __component__$6.options.__file = "panel-src/components/Analytics.vue";
    ...
    !function(t, e) {
      ...
      var C = { name: "en", options: { months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], shortDays: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], toolbar: { exportToSVG: "Download SVG", exportToPNG: "Download PNG", exportToCSV: "Download CSV", menu: "Menu", selection: "Selection", selectionZoom: "Selection Zoom", zoomIn: "Zoom In", zoomOut: "Zoom Out", pan: "Panning", reset: "Reset Zoom" } } }, L = function() {
        ...
        return r(t2, [{ key: "init", value: function(t3) {
          ...
          if (a2 && i(a2) === "object") {
            var l2 = {};
            l2 = ["line", "area", "bar", "candlestick", "boxPlot", "rangeBar", "rangeArea", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a2.chart.type) !== -1 ? r2[a2.chart.type]() : r2.line(), a2.chart.brush && a2.chart.brush.enabled && (l2 = r2.brush(l2)), a2.chart.stacked && a2.chart.stackType === "100%" && (a2 = r2.stacked100(a2)), this.checkForDarkTheme(window.Apex), this.checkForDarkTheme(a2), a2.xaxis = a2.xaxis || window.Apex.xaxis || {}, e2 || (a2.xaxis.convertedCatToNumeric = false), ((a2 = this.checkForCatToNumericXAxis(this.chartType, l2, a2)).chart.sparkline && a2.chart.sparkline.enabled || window.Apex.chart && window.Apex.chart.sparkline && window.Apex.chart.sparkline.enabled) && (l2 = r2.sparkline(l2)), n2 = x.extend(o2, l2);
          }
      ...
      Xt = typeof window != "undefined" ? window : void 0, Et = function(t2, e2) {
        ...
        return a2;
      }, i(exports) === "object" && true ? module.exports = Xt.document ? Et(Xt, Xt.document) : function(t2) {
      ...
      var Bt = function() {
        ...
        return r(t2, [{ key: "render", value: function() {
          ...
          return new Promise(function(s2, r2) {
            ...
            })), a2.config.annotations.position === "back" && (a2.globals.dom.Paper.add(a2.globals.dom.elAnnotations), i2.annotations.drawAxesAnnotations()), !a2.globals.noData) {
  ...
  })(apexcharts_min, apexcharts_min.exports);
  (function(module, exports) {
    (function(global2, factory) {
      module.exports = factory(apexcharts_min.exports);
    })(commonjsGlobal, function(ApexCharts2) {
      ...
      var VueApexCharts2 = ApexChartsComponent;
      window.ApexCharts = ApexCharts2;
      VueApexCharts2.install = function(Vue) {
      ...
      return VueApexCharts2;
    });
  })(vueApexcharts);
  var VueApexCharts = vueApexcharts.exports;
  ...
  const __vue2_script$5 = {
    ...
    methods: {
      getEpisodeGraphData() {
        this.$api.get(`podcaster/stats/graph/downloads/${this.selectedPodcast}/${this.selectedYear}/${this.selectedMonth}`).then((response) => {
  ...
  __component__$5.options.__file = "panel-src/components/GraphDownloadsMonth.vue";
  var PodGraphEpisodesMonth = /* @__PURE__ */ function() {
  ...
  var render$4 = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("section", { staticClass: "k-modified-section podcaster" }, [_c("apexchart", { attrs: { "height": "300", "type": "line", "options": _vm.options, "series": _vm.series } })], 1);
  };
  ...
  const __vue2_script$4 = {
    ...
    methods: {
      getEpisodeGraphData() {
        this.$api.get(`podcaster/stats/graph/episode/${this.selectedPodcast}/${this.selectedEpisode}`).then((response) => {
          const data = [];
  ...
  __component__$4.options.__file = "panel-src/components/GraphSingleEpisode.vue";
  var PodGraphSingleEpisode = /* @__PURE__ */ function() {
  ...
  var render$3 = function() {
    ...
    return _c("div", [_c("k-select-field", { attrs: { "options": _vm.podcastOptions, "label": "Podcast", "name": "select" }, on: { "input": _vm.setPodcast }, model: { value: _vm.selectedPodcast, callback: function($$v) {
      _vm.selectedPodcast = $$v;
    }, expression: "selectedPodcast" } }), _c("k-number-field", { attrs: { "step": 1, "label": "Year" }, on: { "input": _vm.setYear }, model: { value: _vm.selectedYear, callback: function($$v) {
      _vm.selectedYear = $$v;
    }, expression: "selectedYear" } }), _c("k-number-field", { attrs: { "max": 12, "min": 1, "step": 1, "label": "Month" }, on: { "input": _vm.setMonth }, model: { value: _vm.selectedMonth, callback: function($$v) {
      _vm.selectedMonth = $$v;
  ...
  __component__$3.options.__file = "panel-src/components/Navigation.vue";
  var PodNavigation = /* @__PURE__ */ function() {
  ...
  var render$2 = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("k-grid", { attrs: { "gutter": "small" } }, [_c("k-column", { attrs: { "width": "1/4" } }), _vm._l(_vm.reports, function(report, index) {
      return _c("k-column", { key: index, attrs: { "width": "1/4" } }, [_c("k-stats", { attrs: { "reports": [report] } })], 1);
    })], 2);
  };
  ...
  __component__$2.options.__file = "panel-src/components/StatWidget.vue";
  var PodStatWidget = /* @__PURE__ */ function() {
  ...
  __component__$1.options.__file = "panel-src/components/EpisodesTop.vue";
  var PodTopEpisodes = /* @__PURE__ */ function() {
  ...
  var render = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("div", [_c("k-autocomplete", { ref: "autocomplete", attrs: { "options": this.episodes }, on: { "select": _vm.setEpisode } }, [_c("input", { attrs: { "type": "text" }, domProps: { "value": _vm.selectedEpisode }, on: { "input": function($event) {
  ...
  __component__.options.__file = "panel-src/components/EpisodesAutocomplete.vue";
  var PodEpisodesAutocomplete = /* @__PURE__ */ function() {
